...
const DesignPage: React.FC<DesignPageProps> = ({ onBack, onProjectClick }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-white text-black animate-fade-in overflow-y-auto">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('imagenes/diseño_main.png')" }}
      >
        <div className="absolute inset-0 bg-black opacity-30"></div>
        <div className="relative z-10 text-center text-white p-4">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-wider uppercase">UN DISEÑO PARA SENTIR</h1>
        </div>
